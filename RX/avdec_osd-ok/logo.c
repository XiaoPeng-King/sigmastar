...
int logo_display(void)
{
    ...
    printf("TEST_GFX -- srcSurf.u32Width:%d ,srcSurf.u32Height:%d ,srcSurf.eColorFmt:%d ,srcSurf.u32Stride:%d \n",srcSurf.u32Width,srcSurf.u32Height,srcSurf.eColorFmt,srcSurf.u32Stride);
    ...
    printf("TEST_GFX -- xres: %d,yres: %d\n",fb.bmWidth,fb.bmHeight);
    printf("TEST_GFX -- xres: %d,yres: %d,,finfo.line_length: %d,g_stLayerInfo.eFbColorFmt: %d \n",vinfo.xres,vinfo.yres,finfo.line_length,g_stLayerInfo.eFbColorFmt);
    printf("TEST_GFX -- fb.bmWidth: %d,fb.bmHeight: %d,fb.bmPitch: %d,fb.bmBitsPerPixel: %d,fb.bmBytesPerPixel: %d\n",fb.bmWidth,fb.bmHeight,fb.bmPitch,fb.bmBitsPerPixel,fb.bmBytesPerPixel);
    ...
    printf("NO GFX -- fb.bmWidth: %d,fb.bmHeights: %d\n",fb.bmWidth,fb.bmHeight);
    printf("NO GFX -- xres: %d,yres: %d,line_length: %d,eFbColorFmt: %d \n",vinfo.xres,vinfo.yres,finfo.line_length,g_stLayerInfo.eFbColorFmt);
