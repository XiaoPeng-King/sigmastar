...
#define FILE_PATH_NAME "/tmp/web.tar.gz"
#define FILE_TAR_PATH "/bin/tar vxf /tmp/web.tar.gz -C /tmp/"
#define KILL_PROCESS "/bin/killall rtsp-mdev-vpu0-vpp_pv"
...
#if 1
	if(chmod("/tmp/web.tar.gz", S_IRUSR|S_IXUSR|S_IWUSR|S_IXOTH|S_IROTH|S_IWOTH|S_IRGRP|S_IWGRP|S_IXGRP)!=0)
	{
		 printf("\ncm fail");
		 return 0;
	}
