...
void main(void)
{
    ...
    sscanf(data,"ip=%[^&]&mask=%[^&]&gateway=%[^&]&multicast=%[^&]",share_mem->sm_eth_setting.strEthIp,share_mem->sm_eth_setting.strEthMask,share_mem->sm_eth_setting.strEthGateway,share_mem->sm_eth_setting.strEthMulticast);
