...
MI_S32 createOutputFileName(AiOutFileName_t *pstAiOutFileName, MI_U32 u32ChnIdx)
{
    ...
    else if (AI_DEV_LineIn == pstAiOutFileName->AiDevId)
    {
            ...
            case 'r':
                {
                    ...
                    printf("eAiOutputResampleRate: %d \n", eAiOutputResampleRate);
                }
                break;
