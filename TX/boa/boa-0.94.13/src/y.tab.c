...
const int YY_parse_CLASS::STMT_NO_ARGS=258;
const int YY_parse_CLASS::STMT_ONE_ARG=259;
const int YY_parse_CLASS::STMT_TWO_ARGS=260;
const int YY_parse_CLASS::MIMETYPE=261;
const int YY_parse_CLASS::STRING=262;
const int YY_parse_CLASS::INTEGER=263;
...
static const short yyprhs[] = {     0,
     0,     3,     6,     7,     9,    11,    13,    15,    18,    19,
    24,    27,    28,    29,    33,    36,    37
};

static const short yyrhs[] = {    10,
    16,     0,    10,    11,     0,     0,    12,     0,    13,     0,
    14,     0,     3,     0,     4,     7,     0,     0,     5,     7,
    15,     7,     0,    16,    17,     0,     0,     0,     6,    18,
    19,     0,    19,    20,     0,     0,     7,     0
};
...
static const short yyrline[] = { 0,
    65,    68,    69,    72,    74,    75,    78,    86,    94,    97,
   109,   110,   113,   116,   118,   119,   122
};

static const char * const yytname[] = {   "$","error","$illegal.","STMT_NO_ARGS",
"STMT_ONE_ARG","STMT_TWO_ARGS","MIMETYPE","STRING","INTEGER","ConfigFiles","BoaConfigStmts",
"BoaConfigStmt","StmtNoArgs","StmtOneArg","StmtTwoArgs","@1","MimeTypeStmts",
"MimeTypeStmt","@2","ExtensionList","Extension",""
};
#endif

static const short yyr1[] = {     0,
     9,    10,    10,    11,    11,    11,    12,    13,    15,    14,
    16,    16,    18,    17,    19,    19,    20
};
...
static const short yydefact[] = {     3,
    12,     7,     0,     0,     2,     4,     5,     6,     1,     8,
     9,    13,    11,     0,    16,    10,    14,    17,    15,     0,
     0,     0
};

static const short yydefgoto[] = {    20,
     1,     5,     6,     7,     8,    14,     9,    13,    15,    17,
    19
};

static const short yypact[] = {-32768,
    -3,-32768,    -4,    -2,-32768,-32768,-32768,-32768,     0,-32768,
-32768,-32768,-32768,     1,-32768,-32768,     2,-32768,-32768,     4,
     7,-32768
};
